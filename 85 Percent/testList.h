...
//
   ...
   {  // setup
      std::allocator<custom::list> alloc;
      custom::list l;
      l.pHead = (custom::list::Node*)0xBADF00D1;
      l.pTail = (custom::list::Node*)0xBADF00D2;
      l.numElements = 99;
      // exercise
   ...
   {  // setup
      custom::list lSrc;
      // exercise
      custom::list lDest(std::move(lSrc));
      // verify
      assertEmptyFixture(lSrc);
      assertEmptyFixture(lDest);
   }  // teardown
   ...
   {  // setup
      ...
      // exercise
      custom::list l(il); // same as list l{...}
      // verify
      //    +----+   +----+   +----+
      //    | 11 | - | 26 | - | 31 |
      //    +----+   +----+   +----+
   ...
   {  // setup
      ...
      //       +----+   +----+
      custom::list lDes;
      custom::list::Node* pDes1 = new custom::list::Node(int(85));
      custom::list::Node* pDes2 = new custom::list::Node(int(99));
      pDes1->pNext = pDes2;
      pDes2->pPrev = pDes1;
      lDes.pHead = pDes1;
      lDes.pTail = pDes2;
   ...
   {  // setup
      ...
      //       +----+   +----+   +----+   +----+
      custom::list lDes;
      custom::list::Node* lDes1 = new custom::list::Node(int(61));
      custom::list::Node* lDes2 = new custom::list::Node(int(73));
      custom::list::Node* lDes3 = new custom::list::Node(int(85));
      custom::list::Node* lDes4 = new custom::list::Node(int(99));
      lDes1->pNext = lDes2;
      lDes2->pNext = lDes3;
      lDes3->pNext = lDes4;
      lDes4->pPrev = lDes3;
   ...
   {  // setup
      ...
      //       +----+
      custom::list l;
      l.pHead = l.pTail = new custom::list::Node(int(99));
      l.numElements = 1;
      std::initializer_list<int> il{ int(11),int(26),int(31) };
      // exercise
      l = il;   // l = {int(11), int(26), int(31) }
   ...
   {  // setup
      ...
      //       +----+   +----+   +----+   +----+
      custom::list l;
      custom::list::Node* p1 = new custom::list::Node(int(61));
      custom::list::Node* p2 = new custom::list::Node(int(73));
      custom::list::Node* p3 = new custom::list::Node(int(85));
      custom::list::Node* p4 = new custom::list::Node(int(99));
      p1->pNext = p2;
      p2->pNext = p3;
      p3->pNext = p4;
      p4->pPrev = p3;
   ...
   {  // setup
      ...
      custom::list l;
      setupStandardFixture(l);
      custom::list::Node* p = new custom::list::Node(int(99));
      l.pTail->pNext = p;
      p->pPrev = l.pTail;
      l.pTail = p;
      l.numElements++;
   ...
   {  // setup
      ...
      custom::list l;
      setupStandardFixture(l);
      custom::list::Node* p1 = l.pHead;
      custom::list::Node* p2 = p1->pNext;
      custom::list::Node* p3 = p2->pNext;
      itErase.p = l.pHead;
      // exercise
      itReturn = l.erase(itErase);
      // verify
    ...
    *       +----+   +----+   +----+
    ****************************************************************/
   void setupStandardFixture(custom::list& l)
   {
      // allocat
      custom::list::Node* p1 = new custom::list::Node(int(11));
      custom::list::Node* p2 = new custom::list::Node(int(26));
      custom::list::Node* p3 = new custom::list::Node(int(31));
    ...
    *       +----+   +----+   +----+
    ****************************************************************/
   void teardownStandardFixture(custom::list& l)
   {
      if (l.pHead != NULL)
      {
    ...
    ****************************************************************/
   void assertEmptyFixtureParameters(const custom::list& l, int line, const char* function)
   {
    ...
    *       +----+   +----+   +----+
    ****************************************************************/
   void assertStandardFixtureParameters(const custom::list& l, int line, const char* function)
   {
      // verify the member variables
